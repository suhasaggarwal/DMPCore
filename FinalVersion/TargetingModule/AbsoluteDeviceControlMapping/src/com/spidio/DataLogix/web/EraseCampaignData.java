...
public class EraseCampaignData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("fingerprintId")!=null && 
			...
			campaign_mapping = "";
			IndexCategoriesData.updateDocument(client, "dmpdata","core2",document_id, "campaign_mapping", campaign_mapping);
			}			
	}
