...
<html>
    <head>
        ...
        <title>Welcome to Lightning Ad Serving Platform Test Page</title>
    </head>
    <body>
    <% if(!auth) {%>
    ...
    <% } else { %>
    <h1>Welcome to Lightning Ad Service  Test Page</h1>
    
    <form name="form1" action="Controller" method="post">
     <table>
           
         <tr><td>Site ID (Eros id)</td><td><input type="text" name="siteId" value="1"></td></tr>
         <tr><td>Channel Id</td><td> <input type="text" name="chnlid" value="1" ></td></tr>
         <tr><td>IP Address </td>
         <td>
