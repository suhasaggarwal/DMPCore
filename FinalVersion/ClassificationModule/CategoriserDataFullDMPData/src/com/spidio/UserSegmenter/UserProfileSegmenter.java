...
public class UserProfileSegmenter {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 * final BoilerpipeSAXInput in = new BoilerpipeSAXInput(is); final
		 ...
		 * System
		 * .out.println("Final Filtered Terms : "+topiaDoc.getFinalFilteredTerms
		 * ());
		 */
		...
		// doc =
		// Jsoup.connect("http://indianexpress.com/article/technology/gadgets/sony-playstation-vr-headset-price-specs-sale-october/").get();
		...
		// "livedmpindex","core2",id,"category",category);
	}
